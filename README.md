...
Начните с краткого названия, которое точно отражает суть вашего проекта. За ним должно следовать подробное описание проекта. Что делает ваш проект? Какие проблемы он решает? Почему он ценен?
